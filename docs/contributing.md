...
Contributions are welcome. `go-ruby-puppet-resource-api/puppet-resource-api` is built to a small set of
...
The library is in [`github.com/go-ruby-puppet-resource-api/puppet-resource-api`](https://github.com/go-ruby-puppet-resource-api/puppet-resource-api).
This documentation site is in [`github.com/go-ruby-puppet-resource-api/docs`](https://github.com/go-ruby-puppet-resource-api/docs).
