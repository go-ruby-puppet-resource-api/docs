...
The public API lives at the module root (`github.com/go-ruby-puppet-resource-api/puppet-resource-api`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `puppet-resource-api`, while the surface follows
...
```go
import "github.com/go-ruby-puppet-resource-api/puppet-resource-api"
```
...
- **[pkg.go.dev/github.com/go-ruby-puppet-resource-api/puppet-resource-api](https://pkg.go.dev/github.com/go-ruby-puppet-resource-api/puppet-resource-api)**

The module's [README](https://github.com/go-ruby-puppet-resource-api/puppet-resource-api#readme) carries worked
